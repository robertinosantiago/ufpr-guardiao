<h1><?php echo __('Nível de acesso'); ?></h1>
...
<?php echo $this->Form->create('Nivel', array('action' => 'save', 'role' => 'form')); ?>

<?php echo $this->Form->input('Nivel.titulo', array('label' => __('Título'), 'class' => 'form-control', 'div' => 'form-group')); ?>
<?php echo $this->Form->input('Nivel.descricao', array('label' => __('Descrição'), 'class' => 'form-control', 'div' => 'form-group')); ?>
